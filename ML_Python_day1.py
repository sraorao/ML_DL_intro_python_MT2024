...
multicollinearity_pairs = [("median_age", "life_expectancy"), ("life_expectancy", "aged_65_older")]
...
X_a = X[["cases_per_million", "cases", "median_age", "gdp_per_capita", "hdi"]]
...
# Residual Analysis
# Reverse the log10 transformation for residual analysis
residuals = ya_test_exp - predictions_exp
...
plt.grid(True)
plt.show()
#Note: some non-linear relationships are present in the data, but LM is still the best model
...
plt.show()
#Note1: hdi is the most significant, while cases_per_million and cases have less influence
